...
public class Bai4 extends AsyncTask<String, String, String>{
    ...
    @Override
    protected String doInBackground (String... params) { publishProgress ("Sleeping...");
        try {
            int time = Integer.parseInt (params[0])* 1000; Thread.sleep(time);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn:
                Bai4 bai4 = new Bai4(context, tv, time);
